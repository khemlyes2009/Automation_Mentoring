...
public class Burger {
	...
	public Burger(String nameOfBurger) {
		...
		System.out.println("Burger name is "+ this.nameOfBurger);//Passing value to global variable
		//System.out.println("Burger name is "+ nameOfBurger);//using local variable
	}
	...
	public Burger(String nameOfBurger, String topping,char size) {
		...
		System.out.println("Burger name is "+ burgerName + "Burger size "+burgerSize + " Topping "+ burgerTopping);
	}
	...
	public Burger(String nameOfBurger, String topping,char size, double priceOfBurger, int quantityOfBurger, double totalValue, boolean isBurgerAvailable) {
		...
		System.out.println("Burger name is "+ burgerName + "Burger size "+burgerSize + " Topping "+ burgerTopping+" Burger Price "+burgerPrice+" Quantity "+ burgerQuantity+" Total value "+burgerTotalValue+" Burger Availability "+burgerAvailabilityCheck);
	}
	
	public static void main(String[] args) {

		Burger myBurger = new Burger(); // Default constructor
		...
		Burger khushbu = new Burger("Wendys", "tomato", 'S', 10.99, 61, 670.39, true);
